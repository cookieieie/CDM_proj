...
```{r}
# focus on one single condition of complex structure, dim of 5 and correlation of 0.3
irt_data_res_complex_dim5_cor0.3 <- irt_data_res_complex_dim5[grep("cor0\\.3", names(irt_data_res_complex_dim5))]
...
for (i in 1:10) {
  ...
  # extract the list of output for each data set
  data_i <- irt_data_res_complex_dim5_cor0.3[[data_name]]
