...
for (f in files) {
  ...
  theta_path  <- file.path("../IRT_sim/data", theta_fname)
...
write.csv(result_df_rep, "../IRT_sim/cor_result_rep.csv", row.names = TRUE)
write.csv(result_df_rep_12, "../IRT_sim/result_df_rep_12.csv", row.names = TRUE)
write.csv(result_df_rep_48, "../IRT_sim/result_df_rep_48.csv", row.names = TRUE)
```
